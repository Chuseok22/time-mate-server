package com.chuseok22.timemateserver.common.application.aop;
...
public class MethodInvocationLoggingAspect {
   ...
   */
  @Around("@annotation(com.chuseok22.timemateserver.common.application.aop.LogMethodInvocation) || @annotation(com.chuseok22.timemateserver.common.application.aop.LogMonitoringInvocation)")
