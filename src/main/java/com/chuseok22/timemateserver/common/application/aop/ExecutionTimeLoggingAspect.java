...
public class ExecutionTimeLoggingAspect {
   ...
   */
  @Around("@annotation(com.chuseok22.timemateserver.common.application.aop.LogTimeInvocation) || @annotation(com.chuseok22.timemateserver.common.application.aop.LogMonitoringInvocation)")
